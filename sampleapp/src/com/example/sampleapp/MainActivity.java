		...
		button2.setOnClickListener(new OnClickListener() {
					...
					@Override
						public void onClick(View arg0) {
							...
							webView.loadUrl("http://134.193.136.114:8181/HDFSWS/jaxrs/generic/hadoopRun/-home-group5-WordCountExercise.jar");
						}
   ...
   protected String doInBackground(String... urls) {
       try {
       	...
       	JSch ssh = new JSch();
		        ...
		        Session session;
				try {
					session = ssh.getSession("group5", "134.193.136.114", 22);
				
		        session.setPassword("group5");
		        session.connect();
				...
				Log.i(null,directory+"/GPS2.txt");
				
		        
		        sftp.put(directory+"/GPS2.txt", "/home/group5/");
